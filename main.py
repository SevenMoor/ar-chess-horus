...
parser.add_argument("-t","--trapeze",help="Ouvre la fenêtre de visualisation du Trapèze extrait",action="store_true")
parser.add_argument("-i","--integration-test",help="Indique de transmettre des données factices pour tester l'intégration",action="store_true")
